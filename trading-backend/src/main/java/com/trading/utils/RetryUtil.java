 ...
 * 
 * Modern design:
 * - Uses LockSupport.parkNanos instead of Thread.sleep for virtual thread compatibility
 * - Non-blocking waits that don't block carrier threads
 * 
...
public class RetryUtil {
     ...
     * Uses LockSupport.parkNanos for non-blocking backoff waits.
     * 
        ...
        for (int attempt = 1; attempt <= maxAttempts; attempt++) {
            try {
                ...
                if (attempt < maxAttempts) {
                    ...
                    // Modern: Use LockSupport.parkNanos instead of Thread.sleep
                    // This is virtual thread friendly and doesn't block carrier threads
